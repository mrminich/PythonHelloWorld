...
# emoji from PyPi - https://pypi.org/project/emoji/
...
while not isGameOver:
  ...
  # change color to red circle
  elif userInput in ["R"]:
    fillSymbol = emoji.emojize(':red_circle:')

  # change color to white circle
  elif userInput in ["W"]:
    fillSymbol = emoji.emojize(':white_circle:')

  # change color to blue circle
  elif userInput in ["B"]:
    fillSymbol = emoji.emojize(':blue_circle:')
